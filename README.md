...
Questions and reports in any language are welcome through [source issues](https://github.com/pcssakinc/pcssak-palette-source/issues). Reports about existing installers can also use [Palette release issues](https://github.com/pcssakinc/pcssak-palette-releases/issues). Please read the [privacy notice](docs/PRIVACY.md) and use the private route in [SECURITY.md](SECURITY.md) for vulnerabilities.

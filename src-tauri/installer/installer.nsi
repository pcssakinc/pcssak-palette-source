...
; NSIS의 기본 코드페이지 필터로 일부 지원 언어가 목록에서 숨지 않도록 합니다.
...
; 2. License Page (신규 설치에서만 선택 언어의 전문을 표시)
!if "${LICENSE}" != ""
...
;Languages
; NSIS의 SpanishInternational은 LANGID 3082(스페인)입니다.
...
; 설치기에서 선택한 언어와 같은 EULA 전문을 표시합니다.
LicenseLangString PcssakEula ${LANG_ENGLISH} "${PCSSAK_EULA_DIR}\en.txt"
LicenseLangString PcssakEula ${LANG_KOREAN} "${PCSSAK_EULA_DIR}\ko.txt"
LicenseLangString PcssakEula ${LANG_JAPANESE} "${PCSSAK_EULA_DIR}\ja.txt"
LicenseLangString PcssakEula ${LANG_SIMPCHINESE} "${PCSSAK_EULA_DIR}\zh-Hans.txt"
LicenseLangString PcssakEula ${LANG_TRADCHINESE} "${PCSSAK_EULA_DIR}\zh-Hant.txt"
LicenseLangString PcssakEula ${LANG_FRENCH} "${PCSSAK_EULA_DIR}\fr.txt"
LicenseLangString PcssakEula ${LANG_GERMAN} "${PCSSAK_EULA_DIR}\de.txt"
LicenseLangString PcssakEula ${LANG_RUSSIAN} "${PCSSAK_EULA_DIR}\ru.txt"
LicenseLangString PcssakEula ${LANG_SPANISH} "${PCSSAK_EULA_DIR}\es.txt"
LicenseLangString PcssakEula ${LANG_SPANISHINTERNATIONAL} "${PCSSAK_EULA_DIR}\es-419.txt"
LicenseLangString PcssakEula ${LANG_PORTUGUESEBR} "${PCSSAK_EULA_DIR}\pt-BR.txt"
LicenseLangString PcssakEula ${LANG_TURKISH} "${PCSSAK_EULA_DIR}\tr.txt"

Function RestoreSupportedInstallerLanguage
  ReadRegStr $R8 HKCU "${MANUPRODUCTKEY}" "Installer Language"
  ${If} $R8 = ${LANG_ENGLISH}
  ${OrIf} $R8 = ${LANG_KOREAN}
  ${OrIf} $R8 = ${LANG_JAPANESE}
  ${OrIf} $R8 = ${LANG_SIMPCHINESE}
  ${OrIf} $R8 = ${LANG_TRADCHINESE}
  ${OrIf} $R8 = ${LANG_FRENCH}
  ${OrIf} $R8 = ${LANG_GERMAN}
  ${OrIf} $R8 = ${LANG_RUSSIAN}
  ${OrIf} $R8 = ${LANG_SPANISH}
  ${OrIf} $R8 = ${LANG_SPANISHINTERNATIONAL}
  ${OrIf} $R8 = ${LANG_PORTUGUESEBR}
  ${OrIf} $R8 = ${LANG_TURKISH}
    StrCpy $LANGUAGE $R8
  ${EndIf}
FunctionEnd

Function SelectFreshInstallSpanishDefault
...
Function SkipLicenseUnlessFreshInstall
  ${If} $PassiveMode = 1
  ${OrIf} $UpdateMode = 1
